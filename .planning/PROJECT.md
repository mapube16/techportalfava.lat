...
| El Tipo del tecnico tiene VIGENCIA TEMPORAL (2026-08-01) | 7 transiciones medidas en 2025, siempre en tramos de fechas contiguos. Implica technician_specialties(technician_id, role_type_id, valid_from) y que daily_entries.role_type_id SOBRA: es derivable de (tecnico, fecha) | Pendiente |
