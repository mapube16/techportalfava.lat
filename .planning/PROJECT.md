...
- **Cotizaciones 2026-08-01:** `docs/cotizaciones/` — 9 documentos extraidos del stream OLE del .xls (venian pegados como imagen, invisibles al leer celdas). Son el origen del vendido.
...
| Vendido = TOT GG CON VIAGGI, no GIORNI EFFETTIVI (2026-08-01) | Extraidas las 9 cotizaciones pegadas como IMAGEN en las hojas. JAV vende 15/182/130 y son la columna "tot gg con viaggi"; los "giorni effettivi" son 141 y 100. El importe tambien sale de esa columna (182x430=78.260). Confundirlas descuadra el delta ~30% | ✓ Verificada |
| Los dias vendidos son un BOLSON de dias-tecnico (2026-08-01) | La cotizacion dice NR. TECNICI = 1 y 144 dias para Meccanico en Lucchetti, pero ejecutaron DOS mecanicos (62+56=118). El numero de personas es indiferente: consumen del mismo bolson por (maquina, fase, rol) | ✓ Verificada |
| Las lineas de cotizacion NO son unicas por rol (2026-08-01) | Una cotizacion tiene dos lineas MECCATRONICO (265 y 98) en el mismo bloque, y lineas que son un nombre propio («FELIPE SENA», «FELIPE SENA (COSTO)») a 85 EUR/dia. La clave debe ser (orden, fase, ordinal), no (orden, fase, rol) | ✓ Verificada |
| El valor del contrato es el RISERVATO, no la suma de lineas (2026-08-01) | Lucchetti suma 168.500 y reserva 160.000; JAV suma 191.150 y reserva 182.500. La hoja guarda el reservado. Ademas la cotizacion de JAV tiene un error de formula: su total de collaudo deja fuera la linea TEST I/O | ✓ Verificada |
| Existen DOS tarifarios por rol (2026-08-01) | Tarifa A: Meccanico 430, Elettricista 440, Softwerista 600. Tarifa B: Meccanico 350, Elettricista 215, Softwerista 500, Meccatronico 350, Capo Elettricista 400. El supervisor vale 650 en ambas. La tarifa no puede colgar del catalogo de roles | ✓ Verificada |
| SUPERVISORE FLA = MANAGER CANTIERE FLA (2026-08-01) | Mismo rol con dos etiquetas y el mismo precio (650) en cotizaciones distintas. Cierra la duda que quedo abierta sobre «Supervisore», que no aparecia en la columna Tipo | ✓ Verificada |
| Jornada contractual: L-V 10h, sabado medio dia, domingo descanso (2026-08-01) | Literal de las cotizaciones, con «rientro ogni 8/9 settimane». Da sentido a MD (= sabado) y a DVRC (= la rotacion de 8-9 semanas) | ✓ Verificada |
| Leomar Klein = Leomir Klein = Leomir Kleir (2026-08-01) | Misma persona, confirmado por el usuario. Se fusionan en la migracion; falta elegir el nombre canonico | ✓ Confirmada |
